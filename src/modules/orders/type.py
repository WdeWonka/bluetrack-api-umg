...
class OrderCreate(BaseModel):
    ...
    fecha_solicitud: Optional[datetime | str] = Field(
        None,
    ...
    @classmethod
    def validate_fecha(cls, v: Optional[str]) -> datetime:
        if v is None:
            return datetime.now()
...
class OrderUpdate(BaseModel):
    ...
    cantidad: Optional[int] = Field(default=None, gt=0, le=1000)
    fecha_solicitud: Optional[datetime | str] = None
